...
namespace STMIS.Controllers
{
    public class EOTController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MarksId,SubjectId,StudentId,ClassId,Marks,Status")] EndOftermMarksTable endOftermMarksTable)
        {
        ...
        private bool EndOftermMarksTableExists(string id)
        {
